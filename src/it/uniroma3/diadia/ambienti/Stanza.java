...
public class Stanza {
	...
	private HashMap<Direzioni, Stanza> stanzeAdiacenti;
	...
	public void impostaStanzaAdiacente(String direzione, Stanza stanza) {
			this.stanzeAdiacenti.put(Direzioni.valueOf(direzione), stanza);
	}
	...
	/*Getter e setter del personaggio
	 * 
	 */
	...
	public String toString() {
		...
		risultato.append("\nPersonaggi nella stanza: " + this.getPersonaggio().getNome());
		} else {
	...
	public HashMap<Direzioni, Stanza> getMapStanzeAdiacenti() {
